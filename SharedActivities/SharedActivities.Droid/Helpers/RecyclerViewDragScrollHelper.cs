...
namespace SharedActivities.Droid.Helpers {
    public class RecyclerViewDragScrollHelper {
        ...
        Handler updateDragHandler = new Handler(); //to pass the dragEvent in the uithread
        ...
        /// <returns></returns>
        public async Task HandleDragAsync(View view, DragEvent dragEvent) {
            ...
            switch (action) {
                ...
                case DragAction.Location:
                    var dragpoint = new FPoint(dragEvent.GetX(), dragEvent.GetY());
                    await HandleLocationAsync(view, dragpoint);
                    break;
        ...
        /// <returns></returns>
        private async Task HandleLocationAsync(View viewHoveredOver, FPoint position) {
            ...
            if (recyclerView != null &&
                ...
                var pointInRecyclerView = viewHoveredOver.GetPointRelativeTo(recyclerView, position);
                ...
                await InScrollPostionAsync(newScrollDirection, recyclerView, scrollX, scrollY);
        ...
        /// <returns></returns>
        private async Task InScrollPostionAsync(
